...
imagenet100_path = '/HOME/scz1839/run/data/data/seed_1993_subset_100_imagenet/data'
test_filepath = imagenet100_path + '/test'
train_filepath = imagenet100_path + '/train'

info = {"train_num": [], "test_num": []}


def getdividedImagenet100(classnum_init, classnum_per_batch, isrand=False):
    '''
    Args:
    ...
    Usage:
        generate a file called 'imagenet100_divide_info_n_m.npy'
    '''

    TOTAL = (100 - classnum_init) // classnum_per_batch

    if isrand:
        randlst = [i for i in range(100)]
    else:
    ...
    np.save('./save/imagenet100_divide_info_{}_{}.npy'.format(classnum_init, classnum_per_batch), info)
...
class GenerageInfo():
    ...
    Usage:
        ...
        will generate a file called 'imagenet100_num_info_n_m.npy'
    """
    ...
    def get_num_info(self):
        ...
        np.save('./save/imagenet100_num_info_{}_{}.npy'.format(self.n, self.m), info)

        return True


def main(k, n, m):
    getdividedImagenet100(n, m, False)
...
if __name__ == '__main__':
    print("divideimagenet100.py", flush=True)
